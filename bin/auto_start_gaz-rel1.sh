...
xhost +
gnome-terminal -- bash -c "sudo -S ./dockerRun1.sh -n -c gaz_rel1 -b network1 raslaunch1.sh gaz; bash"
gnome-terminal -- bash -c "sudo -S docker exec -it gaz_rel1 bash; bash"
